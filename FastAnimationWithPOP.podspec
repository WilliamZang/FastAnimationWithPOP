Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "A very fast animation framework. Powerby Facebook POP. Add animation without code."

  s.description  = <<-DESC
                   A longer description of FastAnimationWithPOP in Markdown format.
